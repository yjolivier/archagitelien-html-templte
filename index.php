		...
		<div class="container-fluid">
			...
			<section class="section-evenement row">
				<div class="section-evenement-title col-md-12 col-lg-12 col-sm-12">
					<h3>Le Lorem Ipsum est simplement du faux</h3>
					<p> texte employé dans la composition texte employé dans la composition texte employé dans la composition</p>
				</div>
